...
const size_t rustsimplicity_0_7_c_sizeof_elementsTxEnv = sizeof(txEnv);
...
const size_t rustsimplicity_0_7_c_alignof_elementsTxEnv = alignof(txEnv);

void rustsimplicity_0_7_c_elements_set_txEnv(txEnv *result, const elementsTransaction *tx, const elementsTapEnv *taproot, const unsigned char *genesisHash, unsigned int ix)
{
